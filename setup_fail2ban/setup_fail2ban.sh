...
ar18.script.source_or_execute_config "source" "setup_fail2ban" "${ar18_deployment_target}"

ar18.script.obtain_sudo_password

ar18.pacman.install fail2ban
ar18.script.execute_with_sudo cp -f "${script_dir}/jail_file" "/etc/fail2ban/jail.local"
ar18.script.execute_with_sudo chown root:root "/etc/fail2ban/jail.local"
ar18.script.execute_with_sudo chmod 644 "/etc/fail2ban/jail.local"
ar18.script.execute_with_sudo sed -i "s/{{port}}/${ar18_port}/g" "/etc/fail2ban/jail.local"
